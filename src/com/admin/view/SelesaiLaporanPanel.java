...
import com.controller.SelesaiLaporanController;
 ...
 * @author hp
 */
public class SelesaiLaporanPanel extends javax.swing.JFrame {

    /**
     * Creates new form SelesaiLaporanPanel
     */
    
    
    public SelesaiLaporanPanel(Laporan laporan) {
        initComponents();
        this.setLocationRelativeTo(null);
        SelesaiLaporanController selesaiLaporan = new SelesaiLaporanController(this,laporan);
    }

    private SelesaiLaporanPanel() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selesaikan Laporan");

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tanggapan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 14))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelesaiLaporanPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelesaiLaporanPanel().setVisible(true);
            }
        });
    }
